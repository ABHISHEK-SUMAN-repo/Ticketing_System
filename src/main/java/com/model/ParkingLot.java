...
import com.exception.InvalidSlotException;
import com.exception.ParkingLotException;
import com.exception.SlotAlreadyOccupiedException;
...
public class ParkingLot {
  ...
  public Slot makeSlotFree(final Integer slotNumber) {
    ...
    System.out.println("Slot number "+slotNumber+" vacated "+", the car with vehicle registration number "+ slot.getParkedCar().getRegistrationNumber()+" left the space, the driver of the car was of age "+slot.getParkedCar().getDriverAge());
