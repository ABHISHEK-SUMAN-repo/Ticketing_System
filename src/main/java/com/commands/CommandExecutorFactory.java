...
import com.exception.InvalidCommandException;
...
public class CommandExecutorFactory {
  ...
  public CommandExecutorFactory(final ParkingLotService parkingLotService) {
    ...
    commands.put(
        DriverAgeToRegNumberCommandExecutor.COMMAND_NAME,
        new DriverAgeToRegNumberCommandExecutor(parkingLotService, outputPrinter));
    commands.put(
        DriverAgeToSlotNumberCommandExecutor.COMMAND_NAME,
        new DriverAgeToSlotNumberCommandExecutor(parkingLotService, outputPrinter));
    commands.put(
