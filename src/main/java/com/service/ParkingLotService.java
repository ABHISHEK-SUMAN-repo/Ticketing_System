...
import com.model.parking.strategy.ParkingStrategy;
...
public class ParkingLotService {
  ...
  /**
   * Gets all the slots in which a car with given DriverAghe is parked.
   *
   * @param driverAge DriverAge to be searched.
   * @return All matching slots.
   */
  public List<Slot> getSlotsForDriverAge(final String driverAge) {
